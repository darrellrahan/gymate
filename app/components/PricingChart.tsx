      ...
      <div className="bg-[url('/images/bg/bg.jpg')] px-8 py-16 bg-[50%] bg-no-repeat bg-cover relative space-y-16">
        ...
        <div className="relative flex flex-col gap-4 items-center text-center">
          <Image
            ...
            width={220}
            height={220}
            className="absolute left-[2.95rem] -top-1.5"
          />
        ...
        <div className="grid grid-cols-1 gap-6 z-10 relative">
          <div className="flex flex-col group">
            ...
            <div className="bg-white pb-12 pt-8 shadow-xl flex flex-col items-center justify-center gap-6">
              ...
              <Link
                href="/"
                className="relative text-white flex items-center gap-2 bg-[#FF0336] font-bold px-8 py-4 after:h-[3.5rem] after:absolute after:w-[14rem] after:duration-300 after:ease-linear after:border after:border-[#ff0336] after:-top-3 after:-right-3 hover:after:top-0 hover:after:right-0 mt-4"
              >
